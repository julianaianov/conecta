/**
 * Catálogo visual do dmconecta — espelha os dados demo do app (Recreio dos Bandeirantes).
...
export const DEMO_POSTS: DemoPost[] = [
  {
    ...
    meta: "12 apoios · Recreio Shopping",
  ...
  },
  {
    ...
    author: "Associação Recreio Verde",
  ...
  },
  {
    ...
    author: "Subprefeitura do Recreio",
  ...
  },
  {
    ...
    author: "Recreio Construções Ltda",
    authorId: USER_IDS.empresa,
    neighborhood: "Recreio dos Bandeirantes",
    meta: "Recreio Shopping · dia 15",
